...
class InfoFlow(nn.Module):
    """InfoFlow detector used for the paper benchmark experiments.

    The detector keeps the association-discrepancy temporal backbone and adds
    the paper's information bottleneck and conditional flow density estimator.
    """
